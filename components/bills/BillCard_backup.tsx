...
export default function BillCard({
  ...
  return (
    <>
      ...
      {isModalOpen && (
        <div
          className={`modalOverlay ${isContactGalleryOpen ? 'hasGallery' : ''} ${!isMobileView ? 'hasChatModal' : ''}`}
          onClick={handleCloseModal}
        >
          {/* Desktop: Show ChatModal alongside main modal */}
          {!isMobileView && (
            <ChatModal
              billId={bill.id}
          ...
          {/* Mobile: Full-screen ChatModal */}
          {isMobileView && isChatModalOpen && (
            <div 
              className="mobileFullscreenModal"
              onClick={(e) => e.stopPropagation()}
            >
              <button className="mobileModalClose" onClick={handleCloseChatbot}>
                ×
              </button>
          ...
          {/* Mobile: Full-screen Contact Gallery */}
          {isMobileView && isContactGalleryOpen && (
            <div 
              className="mobileFullscreenModal"
              onClick={(e) => e.stopPropagation()}
            >
          ...
          {/* Main Bill Modal - Hidden on mobile when chatbot/contact is open */}
          {(!isMobileView || (!isChatModalOpen && !isContactGalleryOpen)) && (
            <div
